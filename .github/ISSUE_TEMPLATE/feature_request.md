...
How you imagine it looking in a `Cmd`/`Flag`/`Positional` declaration or in a
generated artifact.

## Compatibility impact

Would this change public types, generated `ArgsType` field names, parser
semantics, schema shape, or validation rules? See `docs/release.md`.
