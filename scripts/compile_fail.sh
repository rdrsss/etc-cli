...
run_case integration_tests/compile_fail/bool_negation_collision.zig "flag long name or alias '--no-color' in 'tool' (or inherited) collides with implicit bool negation"
run_case integration_tests/compile_fail/bool_negation_alias_collision.zig "flag long name or alias '--no-colour' in 'tool' (or inherited) collides with implicit bool negation"
run_case integration_tests/compile_fail/hidden_bool_negation_collision.zig "flag long name or alias '--no-cache' in 'tool' (or inherited) collides with implicit bool negation"
run_case integration_tests/compile_fail/inherited_bool_negation_alias_collision.zig "flag long name or alias '--no-colour' in 'paint' (or inherited) collides with implicit bool negation"
...
run_case integration_tests/compile_fail/duplicate_flag_group.zig "duplicate flag group name 'output'"
run_case integration_tests/compile_fail/empty_flag_group.zig "flag group 'output' in command 'tool' must declare at least one flag"
run_case integration_tests/compile_fail/duplicate_flag_group_member.zig "flag group 'output' in command 'tool' has duplicate flag member '--json'"
run_case integration_tests/compile_fail/unknown_flag_group_member.zig "references unknown flag '--xml'"
run_case integration_tests/compile_fail/noncanonical_flag_group_member.zig "references '--format'; use canonical long flag '--json'"
run_case integration_tests/compile_fail/hidden_visible_flag_group.zig "mixes hidden flag '--secret' with visible flag '--json'"
run_case integration_tests/compile_fail/deprecated_current_flag_group.zig "mixes deprecated flag '--old' with current flag '--json'"
run_case integration_tests/compile_fail/incompatible_flag_group_mode.zig "has incompatible mode .required_exactly_one"
